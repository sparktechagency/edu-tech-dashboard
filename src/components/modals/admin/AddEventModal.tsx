...
const AddEventModal = ({ open, onCancel }: AddEventModalProps) => {
        ...
        >
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                        <Select placeholder="Select group (optional)" className="w-full h-11" allowClear>
                ...
                >
                    <Select placeholder="Select specific user (optional)" className="w-full h-11" allowClear>
